...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-display tracking-wide transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_15px_hsl(185_100%_50%/0.2)] hover:shadow-[0_0_30px_hsl(185_100%_50%/0.3)]",
        ...
        hero: "bg-primary text-primary-foreground font-semibold text-base px-8 py-6 shadow-[0_0_30px_hsl(185_100%_50%/0.3)] hover:scale-105 hover:shadow-[0_0_40px_hsl(185_100%_50%/0.4)]",
        "hero-outline": "border-2 border-primary/60 bg-transparent text-primary font-semibold text-base px-8 py-6 hover:bg-primary/10 hover:border-primary hover:shadow-[0_0_15px_hsl(185_100%_50%/0.2)]",
      },
      size: {
